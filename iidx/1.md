...
TODO: I forget if it's Parameter/Value or Value/Parameter. Anyway, this
tells the game how to count beats. Most songs are 4/4 meter, but
...
- Value: Tick value (this is signed, so negative values are possible)

Not much is known about how these affect grading of each note in the
game, best to just look at existing values and copy those...
